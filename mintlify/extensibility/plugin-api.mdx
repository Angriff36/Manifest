...
You can inspect declared plugins with the [`manifest plugins list`](/cli/commands) CLI command, which reports module name, enabled flag, and whether options are present without importing or executing the plugins.
