...
<Warning>
The resolver stubs are stubs — the query resolvers inline a direct database lookup and the mutation resolvers are scaffolding that you complete against your runtime; they are not a finished server.
</Warning>
