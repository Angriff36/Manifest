...
> `mintlify/language/modules.mdx`). Package pin SoT: `package.json` = **3.6.41**,
...
- [Using Manifest in a New Project](../getting-started/new-project.md)
- [Compile Reference](./cli.md)
