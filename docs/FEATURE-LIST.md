...
| 6. Projections — every registered target | Per-module output file splitting (all targets) | `PARTIAL` | mirror of COMPLIANCE_MATRIX §6 — Prisma + Zod + JSON Schema + Pydantic + Dart + Storybook; Convex/web parked |
