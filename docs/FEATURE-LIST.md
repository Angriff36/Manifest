...
| 6. Projections — every registered target | Per-module output file splitting (all targets) | `PARTIAL` | mirror of COMPLIANCE_MATRIX §6 — + Express; Convex + Hono/Next/Remix/SvelteKit parked |
