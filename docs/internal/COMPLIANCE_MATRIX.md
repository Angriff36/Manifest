...
<!-- Edit 2026-07-15: vNext remainder closed — EvaluationStats counters, diagnostics completeness tests, routes.conformance.test.ts (SHA after commit) -->
...
| [x]    | Canonical routes + `lint-routes`                            | FULLY_IMPLEMENTED     | `src/manifest/projections/routes/routes.conformance.test.ts:1-97` (determinism + manual merge + linter); generator `projections/routes/generator.ts`; CLI `packages/cli/src/commands/lint-routes.ts` — SHA after commit                                                                                                                                                                                                   |
| [x]    | Evaluation step-count instrumentation counters              | FULLY_IMPLEMENTED     | `src/manifest/evaluation-stats.ts:1-18`; `runtime-engine.ts:1049,1075-1098,1976-1978,5398-5399` (`getLastEvaluationStats`); `runtime-evaluation-stats.test.ts:1-83` — SHA after commit                                                                                                                                                                                                                                    |
| [x]    | Diagnostics completeness (transition + concurrency)         | FULLY_IMPLEMENTED     | `src/manifest/runtime-diagnostics-completeness.test.ts:1-90`; fixture `38` transition error string; fixture `54` ConcurrencyConflict shape — SHA after commit                                                                                                                                                                                                                                                             |
...
| [~]    | convex                | PARTIAL                        | core generate + auth seam; 2026-07-15: bare-emit schema/result payloads, seed/assembly fixes, renderable read-policy query enforcement, and `encryptionImport` store-boundary encryption (`3272499`) |
