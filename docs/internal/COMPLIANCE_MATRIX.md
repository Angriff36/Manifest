...
| [x]    | FEATURE-LIST → registry inventory (M12)               | FULLY_IMPLEMENTED     | `scripts/generate-feature-list.ts`; `feature-list-generator.test.ts`; `docs:feature-list` scripts; generated `docs/FEATURE-LIST.md` — SHA after commit |
