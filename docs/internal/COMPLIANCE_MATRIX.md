...
| [x]    | Convex `searchable` → `.searchIndex`                  | FULLY_IMPLEMENTED     | `generator.ts:367-441`; `capabilities.ts` string-gate; `type-mapping.ts:85-87`; `semantics.test.ts` — SHA after commit |
