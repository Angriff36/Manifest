...
| [x]    | Approval `onTimeout: escalate` (open routing)         | FULLY_IMPLEMENTED     | `src/manifest/parser.ts:748-820`; `ir-compiler.ts:934-1005`; `runtime-engine.ts:6550-6590`; fixtures `111`, `103` — SHA after commit |
