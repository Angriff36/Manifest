---
title: "Manifest vNext Migration Guide"
description: "This guide helps plan migration to vNext capabilities while keeping semantics aligned with spec and conformance."
---

<!-- GENERATED FROM docs/migration/vnext-migration-guide.md @ b205b62 — edit the source under /docs and run `node scripts/docs-sync.mjs`. -->
