---
title: "Manifest Language Specification"
description: "Quick routing:"
---

<!-- GENERATED FROM docs/spec/README.md @ b205b62 — edit the source under /docs and run `node scripts/docs-sync.mjs`. -->
