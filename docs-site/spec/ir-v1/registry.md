---
title: "Manifest IR Registries"
description: "This directory contains the JSON schemas for the machine-readable registries"
---

<!-- GENERATED FROM docs/spec/registry/README.md @ b205b62 — edit the source under /docs and run `node scripts/docs-sync.mjs`. -->
