---
title: "Conformance"
description: "Conformance tests are the executable source of truth for Manifest semantics."
---

<!-- GENERATED FROM docs/spec/conformance.md @ b205b62 — edit the source under /docs and run `node scripts/docs-sync.mjs`. -->
