---
title: "Manifest vNext Specification"
description: "This document specifies vNext language and runtime features for Manifest: constraint outcomes, overrides, workflows, concurrency, state transitions, and runt..."
---

<!-- GENERATED FROM docs/spec/manifest-vnext.md @ b205b62 — edit the source under /docs and run `node scripts/docs-sync.mjs`. -->
