---
title: "Manifest IR v1 Semantics"
description: "This document defines the runtime meaning of IR v1. The IR schema is authoritative; this document defines how conforming runtimes MUST interpret it."
---

<!-- GENERATED FROM docs/spec/semantics.md @ b205b62 — edit the source under /docs and run `node scripts/docs-sync.mjs`. -->
