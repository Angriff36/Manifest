...
description: "Manifest Language – House Style (Normative)"
---

<!-- GENERATED FROM docs/contracts/house-style.md @ b205b62 — edit the source under /docs and run `node scripts/docs-sync.mjs`. -->
