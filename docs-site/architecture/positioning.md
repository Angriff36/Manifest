---
title: "Manifest: Architecture and Positioning"
description: "Manifest is a deterministic business rules engine with:"
---

<!-- GENERATED FROM docs/ARCHITECTURE_AND_POSITIONING.md @ b205b62 — edit the source under /docs and run `node scripts/docs-sync.mjs`. -->
