...
description: "This document exists to prevent category errors: Manifest is a deterministic domain DSL, not an infrastructure/deployment manifest format."
---

<!-- GENERATED FROM docs/contracts/deployment-boundaries.md @ b205b62 — edit the source under /docs and run `node scripts/docs-sync.mjs`. -->
