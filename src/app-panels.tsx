...
export function Editor({ value, onChange, lang, readOnly, placeholder }: { value: string; onChange: (v: string) => void; lang: 'manifest' | 'ts'; readOnly?: boolean; placeholder?: string }) {
