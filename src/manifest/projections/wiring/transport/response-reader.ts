...
export type WiringCommandOutcome =
...
export class WiringCommandResponseReader {
  ...
  read(status: number, body: unknown): WiringCommandOutcome {
  ...
  private unauthorized(body: unknown): WiringCommandOutcome {
    return {
      ok: false,
      kind: 'unauthorized',
  ...
  private success(body: unknown): WiringCommandOutcome {
  ...
  private failure(body: unknown): WiringCommandOutcome {
    return {
      ok: false,
