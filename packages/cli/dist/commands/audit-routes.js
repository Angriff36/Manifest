 ...
 */
export function isInCommandsNamespace(filePath) {
 ...
 */
export function hasCommandManifestBacking(filePath, commandsManifest) {
...
export function auditRouteFileContent(content, file, options, ownership) {
    const findings = [];
