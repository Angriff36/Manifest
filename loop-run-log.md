...
```json
{"run_id":"2026-08-21T08:11:26Z","pattern":"daily-triage","source":"gha-dogfood","duration_s":9,"readiness_score":100,"readiness_level":"L3","ci_status":"failure","outcome":"ci-red","workflow_run":"32462008918","note":"Scoreboard only — agent triage owns STATE.md"}
```
