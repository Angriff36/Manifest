...
function checkAssertions(expect: CommandExpectation, result: CommandResult): AssertionSummary {
...
export async function runScript(options: RunOptions): Promise<HarnessOutput> {
